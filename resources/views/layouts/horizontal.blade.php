        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="https://kopapdi-admin.iamevent.my.id/assets/media/logos/kopapdi.png" alt=""
                            height="26">
                    </span>
                    <span class="logo-lg">
                        <img src="https://kopapdi-admin.iamevent.my.id/assets/media/logos/kopapdi.png" alt=""
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('checkin') }}">
                                <i class="bx bx-cast icon nav-icon"></i>
                                <span data-key="t-dashboards">Check In</span>
                                {{-- <div class="arrow-down"></div> --}}
                            </a>
                        </li>
